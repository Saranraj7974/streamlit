...
st.line_chart(data['Close'][selected_stock])
...
with col1:
    st.line_chart(returns[selected_stock], height=300)
    st.caption("Daily Returns")

with col2:
    st.line_chart(log_returns[selected_stock], height=300)
...
sma = data['Close'][selected_stock].rolling(window=20).mean()
ema = data['Close'][selected_stock].ewm(span=20, adjust=False).mean()

fig, ax = plt.subplots(figsize=(10, 4))
ax.plot(data['Close'][selected_stock], label="Close Price", alpha=0.8)
